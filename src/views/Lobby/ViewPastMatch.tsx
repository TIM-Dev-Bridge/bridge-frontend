...
import ScoreBoard from "../Play/components/ScoreBoard";
    ...
    score.getScoreFinishedTour((tourScore)=> {
      const fetchedData: BoardScore[][] = tourScore.map((boardScores)=>{
        return boardScores.newScore.map((score)=>{
          return {
            key: boardScores.board_num.toString().padStart(2,'0') + score.pair_id.toString().padStart(2,'0'),
