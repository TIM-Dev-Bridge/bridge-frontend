    ...
    describe('behavioral', ()=> {
        ...
        test('Input all correct in form register ', async()=> {
            ...
            await act(async()=> {
                ...
                fireEvent.change(screen.getByTestId("register-password"), {target:{value:"P@ssword1234"}})
                fireEvent.change(screen.getByTestId("register-confirmpassword"), {target:{value:"P@ssword1234"}})
                userEvent.click(screen.getAllByText('Continue')[0])
                
            })
            expect(jsonSpy).toHaveBeenCalledWith("http://localhost:4000/register", {"birth_date": "1999-08-13", "confirm_password": "P@ssword1234", "display_name": "displayname", "email": "tete.wittawin@gmail.com", "first_name": "firstname", "last_name": "lastname", "password": "P@ssword1234", "username": "username"})
